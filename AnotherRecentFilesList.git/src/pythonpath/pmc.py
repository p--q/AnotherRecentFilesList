...
Protocol = u'mytools.frame:'
Menu_Path = u'ContextSpecificRecentFileList'
IMPL_NAME = u'mytools.frame.ContextSpecificRecentFileList'
SERVICE_NAME = u'com.sun.star.frame.PopupMenuController'

Node_History = u'/org.openoffice.Office.Histories/Histories'
Node_Common_History = '/org.openoffice.Office.Common/History'

Mod_StartModule = u'com.sun.star.frame.StartModule'
Mod_BasicIDE = u'com.sun.star.script.BasicIDE'
Mod_Chart2 = u'com.sun.star.chart2.ChartDocument'
Mod_Global = u'com.sun.star.text.GlobalDocument'
Mod_Text = u'com.sun.star.text.TextDocument'
Mod_Database = u'com.sun.star.sdb.OfficeDatabaseDocument'
Mod_Spreadsheet = u'com.sun.star.SpreadsheetDocument'
#Mod_Formular = "com.sun.star.formula.FormularProperties"
#Mod_Formula = "com.sun.star.formula.FormulaProperties"

Mod_sdb_prefix = u'com.sun.star.sdb'



class AnotherRecentFilesPopupMenuController(unohelper.Base,
	...
	def register_listener(self):
		...
		hist_list = reader.getPropertyValue(u'PickList')
